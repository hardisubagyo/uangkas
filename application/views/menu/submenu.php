...
<div class="row">
    <div class="col-lg">
        ...
        <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#AddSubmenuModal">Add Submenu</a>
...
<!-- Modal -->
<div class="modal fade" id="AddSubmenuModal" tabindex="-1" role="dialog" aria-labelledby="AddSubmenuModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="AddSubmenuModal">Add Submenu</h5>
