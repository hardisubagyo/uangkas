                        ...
                        <tbody>
                            ...
                            <?php foreach ($kkeluar as $kk) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url(); ?>operasional/editkaskeluar/<?= $kk['id']; ?>" class="badge badge-beige badge-success">Edit</a>
                                        <a href="<?= base_url(); ?>operasional/hapuskaskeluar/<?= $kk['id']; ?>" class="badge badge-beige badge-danger" onclick="return confirm('Yakin data dihapus ?');">Delete</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
...
<div class="modal fade" id="AddKasModal" tabindex="-1" role="dialog" aria-labelledby="AddKasModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('operasional/tambahkaskeluar'); ?>" method="post">
