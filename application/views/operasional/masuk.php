                        ...
                        <tbody>
                            ...
                            <?php foreach ($kmasuk as $km) : ?>
                                <tr>
                                    ...
                                    <td><?= date('d/m/Y', strtotime($km['tgl_input'])); ?></td>

                                    <td>
                                        <a href="<?= base_url(); ?>operasional/editkasmasuk/<?= $km['id']; ?>" class="badge badge-beige badge-success">Edit</a>
                                        <a href="<?= base_url(); ?>operasional/hapus/<?= $km['id']; ?>" class="badge badge-beige badge-danger" onclick="return confirm('Yakin data dihapus ?');">Delete</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
...
<div class="modal fade" id="AddKasModal" tabindex="-1" role="dialog" aria-labelledby="AddKasModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('operasional/tambahkasmasuk'); ?>" method="post">
